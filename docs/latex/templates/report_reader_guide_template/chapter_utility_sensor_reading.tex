...
\item các chart như \texttt{Period sensor trend} hoặc \texttt{Sensor trend by cluster}: dùng để xem đường xu hướng daily aggregate trong suốt kỳ weekly hoặc monthly.
\end{enumerate}
