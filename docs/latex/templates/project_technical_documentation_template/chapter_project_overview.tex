...
Chapter mẫu này chuyển template từ phong cách học thuật tổng quát sang phong cách technical manual cho dự án báo cáo năng lượng. Ở trạng thái hiện tại, bộ tài liệu đã có chapter tổng quan, chapter data sources / mapping, chapter business rules / KPI rules, và chapter output / release operations. Các bước mở rộng tiếp theo có thể tiếp tục bổ sung revision history, glossary, hoặc approval-oriented sections khi cần.
