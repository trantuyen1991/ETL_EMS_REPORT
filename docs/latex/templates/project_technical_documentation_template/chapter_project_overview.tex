...
Chapter mẫu này chuyển template từ phong cách học thuật tổng quát sang phong cách technical manual cho dự án báo cáo năng lượng. Ở trạng thái hiện tại, bộ tài liệu đã có chapter tổng quan và chapter riêng cho business rules / KPI rules. Các bước mở rộng tiếp theo có thể tiếp tục bổ sung chapter cho output structure, release workflow, và troubleshooting.
