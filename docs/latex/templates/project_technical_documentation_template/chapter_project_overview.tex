...
\begin{figure}[H]
	\centering
	% Draw.io source: figure/project_diagrams.drawio, sheet "System Architecture - Vertical Icons".
	% Export artifact: figure/hinh1_1.png.
	\includegraphics[width=\textwidth]{figure/hinh1_1.png}
	\caption{Energy reporting system architecture and trusted data flow}
	\label{fig:system_architecture}
\end{figure}

Hình \ref{fig:system_architecture} mô tả các lớp chính của hệ thống, bao gồm runtime orchestration, nguồn MySQL chính thức, nguồn utility và sensor, repository layer, service layer, và hợp đồng \texttt{report\_context} dùng chung cho HTML, PDF, và Excel outputs.

\begin{figure}[H]
	\centering
	% Draw.io source: figure/project_diagrams.drawio, sheet "Report Flow - Vertical Icons".
	% Export artifact: figure/hinh1_2.png.
	\includegraphics[width=\textwidth]{figure/hinh1_2.png}
	\caption{Top-down report generation and export data flow}
