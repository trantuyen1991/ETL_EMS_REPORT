...
\begin{table}[h]
	...
	\begin{DocHybridTable}{|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
...
\begin{DocHybridTabular}{|p{0.5cm}|l|l|}
