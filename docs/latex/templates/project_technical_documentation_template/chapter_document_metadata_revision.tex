...
\begin{table}[h]
	...
	\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}X|}
		...
		Current document version & \texttt{v0.16-draft} \\ \hline
		...
		Canonical LaTeX source root & \texttt{docs/latex/templates/project\_technical\_documentation\_template/} \\ \hline
		Canonical PDF output & \texttt{docs/output/project\_technical\_documentation\_latest.pdf} \\ \hline
		Expected dated PDF output & \texttt{docs/output/project\_technical\_documentation\_YYYYMMDD.pdf} \\ \hline
