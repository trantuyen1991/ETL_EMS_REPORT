...
\begin{table}[h]
	...
	\begin{DocHybridTable}{|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}X|}
		...
		Current document version & \texttt{v0.9-draft} \\ \hline
...
\begin{table}[h]
	...
	\begin{DocHybridTable}{|>{\raggedright\arraybackslash}p{2.7cm}|>{\raggedright\arraybackslash}X|}
...
\begin{table}[h]
	...
	\begin{DocHybridTable}{|>{\raggedright\arraybackslash}p{2.0cm}|>{\raggedright\arraybackslash}p{2.0cm}|>{\raggedright\arraybackslash}p{2.2cm}|>{\raggedright\arraybackslash}X|}
		...
		\texttt{v0.9-draft} & 2026-05-11 & Internal review copy & Chuyển technical PDF sang screen-first layout: dùng margins trái/phải đối xứng, bỏ twoside spread behavior để header/footer không còn so le, và nâng toàn bộ tables sang hybrid grid style có border nhẹ để đọc trên màn hình rõ hơn. \\ \hline
	\end{DocHybridTable}
\end{table}
