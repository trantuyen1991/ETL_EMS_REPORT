...
\begin{table}[h]
	...
	\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}X|}
		...
		Document scope & Architecture, data sources, repository/service mapping, business rules, KPI rules, output structure, deployment workflow, scheduling, troubleshooting, glossary, and naming conventions \\ \hline
		Current document version & \texttt{v0.14-draft} \\ \hline
