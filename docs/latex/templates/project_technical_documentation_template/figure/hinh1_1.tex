...
\noindent\begin{tikzpicture}[x=1cm,y=1cm]
	...
	\layerbox{1.70}{23.00}{10.95}{LightBlue}{20.00}{BrandBlue}{Runtime and Configuration Inputs}
	\centerbody{6.325}{21.20}{8.45cm}{%
		\texttt{main.py} loads config, logging,\\and MySQL access.\\
		\texttt{PeriodService} resolves run periods\\and canonical output naming.}

	\layerbox{13.05}{23.00}{22.30}{LightGreen}{20.00}{FlowGreen}{Source Data Ownership}
	\centerbody{17.675}{21.20}{8.45cm}{%
		\texttt{total\_energy} owns Electricity official totals;\\\texttt{energy\_kpi} owns KPI values and production rows.\\
	...
	% Connectors
	\draw[-{Latex[length=4mm,width=3mm]}, line width=1.05pt, draw=LineColor] (6.325,20.00) -- (6.325,19.45);
	\draw[-{Latex[length=4mm,width=3mm]}, line width=1.05pt, draw=LineColor] (17.675,20.00) -- (17.675,19.45);
