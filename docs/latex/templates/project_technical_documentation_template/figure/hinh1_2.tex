...
\noindent\begin{tikzpicture}[x=1cm,y=1cm]
	...
	\flowstep{3.35}{FlowGray}{LightGray}{8. Store canonical outputs}{Write \texttt{OUTPUT\_DIR/YYYY\_MM/} artifacts\\with \texttt{01\_monthly / 02\_weekly / 03\_daily} prefixes.\\If blank, fallback to \texttt{output/reports/YYYY\_MM/}.}
