...
Một chi tiết quan trọng là \texttt{EnergyService} không xem raw area views là official totals. Nó sử dụng \texttt{total\_energy} làm reference cho plant total và area total theo các rule đã chốt.
