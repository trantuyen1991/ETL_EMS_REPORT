                                                              ...
                                                              'heatmap': {'height': {'view': {'default': '228px',
                                                                          ...
                                                                          'grid': {'default': {'left': 58,
                                                                                   ...
                                                                                   'monthly': {'left': 18,
                                                                                               ...
                                                                                               'bottom': 62,
                                                                                               'containLabel': False}}},
                                                              'delta': {'familyRef': 'delta.horizontal',
                                                                        'grid': {'left': 52,
                                                                                 'right': 32,
                                                                                 'top': 8,
                                                                                 'bottom': 15,
                                       ...
                                       'utility': {'card': {'totalUtility': {'layout': {'minHeight': '154px',
                                                            ...
                                                            'boilerEnergy': {'layout': {'minHeight': '154px',
                                                                             ...
                                                                             'compare': {'blockMarginTop': '2px',
                                                                                         ...
                                                                                         'labelLetterSpacing': '0.05em',
                                                                                         'valueFontSize': '15px'}}},
                                                   'chart': {'comparison': {'familyRef': 'column.standard',
                                                             ...
                                                             'periodicOverview': {'default': {'view': {'gridModifierClass': '',
                                                                                                       'blockOrder': ['trend', 'deviation', 'heatmap'],
                                                                                                       'heatmapBlockClass': 'utility-chart-block utility-chart-block-heatmap'},
                                                                                              'pdf': {'gridModifierClass': '',
                                                                                                      'blockOrder': ['trend', 'deviation', 'heatmap'],
                                                                                                      'heatmapBlockClass': 'utility-chart-block utility-chart-block-heatmap'}},
                                                                                  'monthly': {'view': {'gridModifierClass': 'utility-periodic-chart-grid-monthly',
                                                                                                       'blockOrder': ['trend', 'heatmap', 'deviation'],
                                                                                                       'heatmapBlockClass': 'utility-chart-block utility-chart-block-heatmap utility-chart-block-heatmap-primary'},
                                                                                              'pdf': {'gridModifierClass': 'utility-periodic-chart-grid-monthly',
                                                                                                      'blockOrder': ['trend', 'heatmap', 'deviation'],
                                                                                                      'heatmapBlockClass': 'utility-chart-block utility-chart-block-heatmap utility-chart-block-heatmap-primary'}}},
                                                             'energyOverview': {'default': {'view': {'gridModifierClass': '',
                                                                                                     'blockOrder': ['trend', 'distribution', 'heatmap']},
                                                                                            'pdf': {'gridModifierClass': '',
                                                                                                    'blockOrder': ['trend', 'distribution', 'heatmap']}},
                                                                                'monthly': {'view': {'gridModifierClass': 'utility-energy-chart-grid-monthly',
                                                                                                     'blockOrder': ['trend', 'distribution', 'heatmap']},
                                                                                            'pdf': {'gridModifierClass': 'utility-energy-chart-grid-monthly',
                                                                                                    'blockOrder': ['trend', 'distribution', 'heatmap']}}},
                                                             'monthlyLayout': {'view': {'gridTemplateColumns': 'minmax(0, 6fr) minmax(0, 4fr)',
                                                                                         'gridAutoFlow': 'row'},
                                                                             'pdf': {'gridTemplateColumns': 'minmax(0, 6fr) minmax(0, 4fr)',
                                                                                     'gridAutoFlow': 'row'}},
                                                             'periodTrend': {'height': {'view': '326px',
                                                                                        'pdf': '228px'},
                                                                             'monthly': {'view': {'height': '262px',
                                                                                                  'gridColumn': '1 / -1'},
                                                                                         'pdf': {'height': '262px',
                                                                                                 'gridColumn': '1 / -1'}}},
                                                             'periodHeatmap': {'height': {'view': '326px',
                                                                                          'pdf': '150px'},
                                                                               'monthly': {'view': {'gridColumn': '1'},
                                                                                           'pdf': {'gridColumn': '1'}}},
                                                             ...
                                                             'energyTrend': {'legend': {'top': 'left'},
                                                                             ...
                                                                             'monthly': {'view': {'height': '262px',
                                                                                         ...
                                                                                         'pdf': {'height': '262px',
                                                                                                 'gridColumn': '1 / -1'}}},
                                                             'energyMonthlyLayout': {'view': {'gridTemplateColumns': 'repeat(2, minmax(0, 1fr))',
                                                                                               'gridAutoFlow': 'row'},
                                                                                     'pdf': {'gridTemplateColumns': 'repeat(2, minmax(0, 1fr))',
                                                                                             'gridAutoFlow': 'row'}},
                                                             'energyHeatmap': {'height': {'view': '192px',
                                                                                          'pdf': '192px'}},
                                                             ...
                                                             'sensorCluster': {'legend': {'bottom': 'center'},
                                                                               ...
                                                                               'height': {'view': '280px',
                                                                                          'pdf': '140px'}},
                                                             'deviation': {'familyRef': 'delta.horizontal',
                                                                           'grid': {'left': 92,
                                                                                    'right': 24,
                                                                                    'top': 10,
                                                                                    'bottom': 28},
                                       ...
                                       'kpi': {'card': {'total': {'layout': {'minHeight': '172px',
                                               ...
                                               'chart': {'dashboard': {'height': {'view': '288px',
                                                         ...
                                                         'waterfall': {'grid': {'left': 32,
                                                                                ...
                                                                                'bottom': 25,
                                                                                'containLabel': True}},
                                                         'variance': {'familyRef': 'delta.horizontal',
                                                                      'grid': {'left': 70,
                                                                               'right': 16,
                                                                               'top': 12,
                                                                               'bottom': 18,
