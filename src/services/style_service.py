                           ...
                           'section': {'electric': {'card': {'total': {'layout': {'minHeight': '150px',
                                       ...
                                       'utility': {'card': {'totalUtility': {'layout': {'minHeight': '154px',
                                                   ...
                                                   'chart': {'comparison': {'familyRef': 'column.standard',
                                                             ...
                                                             'periodicOverview': {'default': {'view': {'layoutVariant': 'default',
                                                                                                       'blockOrder': ['trend', 'deviation', 'heatmap'],
                                                                                                       'heatmapSlot': 'default'},
                                                                                              'pdf': {'layoutVariant': 'default',
                                                                                                      'blockOrder': ['trend', 'deviation', 'heatmap'],
                                                                                                      'heatmapSlot': 'default'}},
                                                                                  'monthly': {'view': {'layoutVariant': 'monthly',
                                                                                                       'blockOrder': ['trend', 'heatmap', 'deviation'],
                                                                                                       'heatmapSlot': 'primary'},
                                                                                              'pdf': {'layoutVariant': 'monthly',
                                                                                                      'blockOrder': ['trend', 'heatmap', 'deviation'],
                                                                                                      'heatmapSlot': 'primary'}}},
                                                             'energyOverview': {'default': {'view': {'layoutVariant': 'default',
